...
namespace PDBG.CRM.WEB.Models
{
    public class YandexService
    {
        ...
        public YandexService(IApiKeyRepository apiKeyRepository)
        {
        ...
        public async Task<string> GetCoordsAsync(string address)
        {
            ...
            if (apiKey != null)
            {
                ...
                var geocode = await httpClient.GetFromJsonAsync<YaGeocode>($"https://geocode-maps.yandex.ru/1.x/?apikey={apiKey}&geocode={address}&format=json");
